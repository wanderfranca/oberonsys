        ...
        <div class="user-block block">
            ...
            <?php if(empty($gruposDisponiveis)): ?>
                ...
                <?php else: ?>
                    ...
                    <p class="contributions text-white mt-0">Esse usuário já faz parte do grupo de administradores. Para associá-lo a outros grupos, primeiro remova-o do grupo de admnistradores.</p>
                ...
                <table class="table table-striped table-bordered table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo character_limiter($info->descricao, 45); ?></td>
                            <td>

                            <?php $atributos = [
                                'onSubmit' => "return confirm('Deseja remover esse usuário do grupo de acesso?');",
                            ]; 

        ...
        <div class="col-md-12">
            ...
            <div class="contributions">
                ...
                <a tabindex="0" style="text-decoration: none;" role="button" data-toggle="popover" data-tigger="focus"
                    title="TAG" data-content="Esse é o código da ordem de serviço, anote para não esquecer">&nbsp;&nbsp;
            ...
            <p class="contributions mt-o"><b class="text-white">Téc. Responsável: </b>
                <?php echo esc($ordem->usuario_responsavel); ?></p>

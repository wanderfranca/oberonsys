...
<head>
	<meta charset="UTF-8">
	<title>Bem vindo ao Codeingniter 4</title>
...
<header>
	...
	<div class="heroe">
		...
		<h1>Bem vindo ao Codeigniter 4 <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

		<h2>Inicindo o curso de codeingniter 4</h2>

		<?php $nome = 'Wander França'; ?>

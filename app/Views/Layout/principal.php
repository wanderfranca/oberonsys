        ...
        <footer class="footer">
          <div class="footer__block block no-margin-bottom">
            <div class="container-fluid text-center">
               <p class="no-margin-bottom"><?php echo date('Y')?> &copy; Para suporte, entre em contato conosco <a target="_blank" href="https://suporteoberon.com.br">Suporte Oberon</a>.</p>
            </div>
          </div>
        </footer>
      </div>

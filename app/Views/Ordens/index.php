...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <div class="block">
            ...
            <a href="<?php echo site_url('ordens/criar');?>" class="btn btn-primary text-white mb-5 mr-1"> NOVA ORDEM DE SERVIÇO </i></a>
            <!-- <a href="<?php echo site_url('ordens/produtosexcluidos');?>" class="btn btn-danger mb-5 mr-1 text-white"> PRODUTOS EXCLUÍDOS </a>
